...
def populate_table_invoices(customer_data, product_data,start_date, end_date,probability_invoice_per_customer_id_per_day,
                            number_different_products_per_invoice,number_items_per_product):
    """
    ...
    :param number_different_products_per_invoice: The number of different products per invoice
    :param number_items_per_product: The number of items for each different product
